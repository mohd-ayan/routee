...
@Component({
    selector     : 'pristine-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : pristineAnimations
})
export class PristineThemeOptionsComponent implements OnInit, OnDestroy
{
    pristineConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._PristineConfigService.config = config;
            });
        ...
        this._PristineNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._PristineNavigationService.removeNavigationItem('custom-function');
    }
