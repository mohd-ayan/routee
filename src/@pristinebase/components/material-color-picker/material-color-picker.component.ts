...
import { MatColors } from '@pristinebase/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const Pristine_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => PristineMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'pristine-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : pristineAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [Pristine_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class PristineMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, pristine-navy-700 etc.)
