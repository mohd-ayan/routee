...
import { PristineSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'pristine-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class PristineSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._PristineConfigService.config
            ...
            .subscribe((config) => {
                this._pristineConfig = config;
            });

        // Register the sidebar
        this._PristineSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._PristineSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('pristine-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('pristine-sidebar-overlay-invisible');
        }
