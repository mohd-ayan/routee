...
import '@pristinebase/components/highlight/prism-languages';

@Component({
    selector : 'pristine-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class PristineHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using pristine-highlight
        // component
