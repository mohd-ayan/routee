...
export class ChatPanelComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    @ViewChildren(PristinePerfectScrollbarDirective)
    private _pristinePerfectScrollbarDirectives: QueryList<PristinePerfectScrollbarDirective>;

    // Private
    private _chatViewScrollbar: PristinePerfectScrollbarDirective;
    ...
    ngOnInit(): void
    {
        ...
        this._PristineSidebarService.getSidebar('chatPanel').foldedChanged
    ...
    {
        this._chatViewScrollbar = this._pristinePerfectScrollbarDirectives.find((directive) => {
    ...
    {
        this._PristineSidebarService.getSidebar('chatPanel').foldTemporarily();
    }
    ...
    {
        this._PristineSidebarService.getSidebar('chatPanel').unfoldTemporarily();
    }
    ...
    {
        this._PristineSidebarService.getSidebar('chatPanel').toggleOpen();
    }
